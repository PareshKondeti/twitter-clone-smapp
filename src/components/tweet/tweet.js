  ...
  return (
    <div id="tweet-box">
      <div id="profile-tweet">
        <img
          src="https://avatars.githubusercontent.com/u/790s=400&u=9376daf7bc67c804b89790ffc455fb5981c6d369&v=4"
          alt="profile"
          id="image-profile"
        />
      </div>
      ...
      <div id="box-tweet">
        <div id="name-id">
          <span id="flex-tweet">
            <p id="tweet-name">Paresh Kondeti</p>
            <p id="tweet-id">@PK . </p>
            <p id="tweet-date">DEC 10</p>
          </span>
